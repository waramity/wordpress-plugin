 ...
 */
function waramity_get_template( string $template, array $variables = [], bool $echo = false ) {

	$template_file = sprintf( '%1$s/templates/%2$s.php', WARAMITY_PLUGIN_PATH, $template );
